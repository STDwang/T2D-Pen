    ...
    TRectangle{
        ...
        Column{
            ...
            Repeater{
                ...
                model: [
                    {label:"Home",icon:TAwesomeType.FA_home,uri:"qrc:/qml/Home.qml"},
                    {label:"Control",icon:TAwesomeType.FA_rocket,uri:"qrc:/qml/Control.qml"},
                    {label:"Demo",icon:TAwesomeType.FA_codiepie,uri:"qrc:/qml/Demo.qml"},
                    {label:"Awesome",icon:TAwesomeType.FA_font_awesome,uri:"qrc:/qml/Awesome.qml"},
